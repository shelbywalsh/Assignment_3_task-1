...
ww_cloud_50 <- ggplot(data = top_50, aes(label = word)) +
  ...
  scale_color_gradientn(colors = c("darkgreen","steelblue1","deepskyblue3")) +
  theme_minimal()
...
willow_afinn_col <- brewer.pal(11, "BrBG")
willow_afinn_col <- colorRampPalette(willow_afinn_col)(713)
